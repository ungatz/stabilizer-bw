...
equilibrium parity-count marginal of LaRacuente's subset-parity Markov chain.
...
* `SubsetParityBWBridge.LaRacuenteCarry.laracuente_carry`
* `SubsetParityBWBridge.Bridge.grade_distribution_eq_laracuente_symmetric_marginal`
