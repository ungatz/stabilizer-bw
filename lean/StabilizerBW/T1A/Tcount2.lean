...
/-!
# T1A — degree-`≤ 2` syntactic T-count enumerator
...
monomials — see the `tCount_ne_grade_overlap_example` refutation in
`GradeEnumerator.lean`). The closed form is
```
...
/-- The degree-`≤ 2` T-count enumerator factorisation. -/
...
/-! ## The tCount vs grade disagreement -/
...
/-- The canonical disagreement: `tCount(x₁x₂ + x₁x₃) = 6`
