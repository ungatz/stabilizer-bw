/-
# PauliLogic/Soundness.lean — Target T3 (soundness side) of the development

Soundness of `PL_n` with respect to the model semantics (see companion narrative
Theorem 17.14, `thm:av-pl-complete`, soundness direction).
