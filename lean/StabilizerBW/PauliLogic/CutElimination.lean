/-
# PauliLogic/CutElimination.lean — Target T4 of the development

Cut elimination for `PL_n` (the companion narrative, `thm:av-cut-elimination`).
...
/- **Cut elimination, computational core** (the companion narrative): every
