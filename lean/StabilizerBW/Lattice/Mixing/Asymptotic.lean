...
/-!
# T5 — Asymptotic (non-rounded) refinement
...
namespace BWParityChainMixingTime.Asymptotic
...
theorem bw_grade_mixing_explicit_constant
  ...
  have hbound := BWParityChainMixingTime.MixingTime.bw_grade_mixing_time_bound
...
end BWParityChainMixingTime.Asymptotic
