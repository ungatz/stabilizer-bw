import RequestProject.Roots.Filtration
import RequestProject.Roots.BW2

/-!
# Tensor subadditivity of the grade and the product bound (T3)

This file mechanizes the structural results :
