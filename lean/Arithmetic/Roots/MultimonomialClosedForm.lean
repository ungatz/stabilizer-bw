import RequestProject.Roots.BWModel
...
* refutes the round's *Boolean-input maximum* candidate `boolMax` (= `ieCand`, since
...
/-! ## The Boolean-input maximum candidate (the round's "Conjecture A") — refuted

The round prompt proposed refining the inclusion-exclusion candidate to the
...
The winning candidate is the prompt's alternative (a): the **Möbius / finite-difference**
